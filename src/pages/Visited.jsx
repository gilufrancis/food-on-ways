  ...
  return (
    <PageWrapper>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-extrabold text-gray-900 leading-tight">Visited</h1>
          <div className="flex items-center gap-2 mt-0.5">
            ...
            {avgRating && (
              <>
                ...
                <span className="text-sm font-semibold text-amber-500">★ {avgRating} avg</span>
              </>
            )}
          </div>
        </div>
      ...
      {visited.length === 0 ? (
        <div className="flex flex-col items-center text-center py-16 px-6">
          ...
          <p className="text-xl font-bold text-gray-800">No visited places yet</p>
